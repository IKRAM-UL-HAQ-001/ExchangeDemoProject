        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-success" onclick="addVenderPayment()">Submit</button>
                </div>
            </div>
        </div>
    </div>
...
function addVenderPayment() {
    ...
    $.ajax({
        url: "{{ route('exchange.vender_payment.store') }}",
        method: "POST",
        data: {
...
function deleteVenderPayment(button, id) {
    ...
    $.ajax({
        url: "{{ route('exchange.vender_payment.destroy') }}",
        method: "POST",
        data: {
            id: id,
            _token: '{{ csrf_token() }}'
